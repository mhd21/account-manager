...
public class TransferTransactionTest {
    ...
    @Test
    public void transfer_set_transaction_type_to_TRANSFER() throws AccountBalanceException {
        BigDecimal amount = BigDecimal.valueOf(20);
    ...
    public void transfer_saves_two_transaction_detail_instances_which_are_related_to_two_accounts()
        ...
        assertEquals(fromAccount.getId().toString(), capturedTransactionDetails.get(0).getAccountId().toString());
        assertEquals(toAccount.getId().toString(), capturedTransactionDetails.get(1).getAccountId().toString());
    }
